  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7]">
      ...
      <div className="bg-[#58CC02] px-6 pt-8 pb-16 flex flex-col items-center">
        ...
        <p className="text-white opacity-80 font-medium text-sm mt-1">{user?.email}</p>

        {/* Stats */}
        <div className="flex gap-4 mt-5">
          <div className="bg-white bg-opacity-20 rounded-2xl px-5 py-3 text-center">
            <div className="text-2xl font-extrabold text-white">{user?.totalRides}</div>
            <div className="text-xs font-bold text-white opacity-80 mt-1">RIDES</div>
          </div>
          <div className="bg-white bg-opacity-20 rounded-2xl px-5 py-3 text-center">
            <div className="text-2xl font-extrabold text-white">{user?.streak} 🔥</div>
            <div className="text-xs font-bold text-white opacity-80 mt-1">STREAK</div>
          </div>
        </div>
      </div>
